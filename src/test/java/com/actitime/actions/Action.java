...
public class Action extends BaseTest {
	...
	public void Actionsclass(WebDriver driver, WebElement ele) {
	...
	public boolean Alerts(WebDriver driver) {
	...
	public void explicitWaitForElement(WebDriver driver, WebElement element, int timeOut ) {
		WebDriverWait wait = new WebDriverWait(driver,timeOut);
		wait.until(ExpectedConditions.visibilityOf(element));
	}
	
	public void explicitWaitForTitle(WebDriver driver, int timeOut,String title ) {
